        <div class="heritage-section" id="placetovisit">
            <div class="container">
                <h2 class="heritage-section-title">placetovisit</h2>
                <div class="row">
                    <?php
                        $select = "select * from placetovisit where like_count in (select max(like_count) from placetovisit); ";
                        ...
                        <div class="heritage-post row most-viewed">
                            ...
                            <div class="heritage-content col-4 column">
                                <div class="heritage-title">
                                    <h3><a href="<?php echo site_url().'/template-parts/placetovisits_page.php?id='.$content['id'].';'?>"><?php echo $content['placetovisit_title']; ?></a></h3>
                                </div>
                                ...
                                <div class="heritage-seemore">
                                    ...
                                    <a href="<?php echo site_url().'/template-parts/placetovisits_page.php?id='.$content['id'].';'?>">seemore</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    ?>
                    <?php
                        $selt = "select * from placetovisit where not id='$maxlikecntid'";
                    ...
                    <div class="col-4" style="order: -<?php echo $cnt['like_count'];?>">
                        <div class="heritage-post">
                            ...
                            <div class="heritage-content">
                                <div class="heritage-title">
                                    <h3><a href="<?php echo site_url().'/template-parts/placetovisits_page.php?id='.$cnt['id'].';'?>"><?php echo $cnt['placetovisit_title']; ?></a></h3>
                                </div>
                                <div class="heritage-desc if-overflow">
                                    <p>
                                        <?php echo $cnt['placetovisit_desc']; ?>
                                    </p>
                                </div>
                                <div class="heritage-seemore">
                                    <?php
                                    ...
                                    ?>
                                    <span><?php echo $time; ?></span>
                                    <a href="<?php echo site_url().'/template-parts/placetovisits_page.php?id='.$cnt['id'].';'?>">seemore</a>
                                </div>
                            </div>
                        </div>
                    </div>
